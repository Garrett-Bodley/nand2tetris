...
# Class that functions as a hash table for assembly symbols
class SymbolTable
  ...
  def get_address(string)
    raise "Provided string was not found in the SymbolTable (Provided string: #{string})" unless contains(string)
